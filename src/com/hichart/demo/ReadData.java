...
public class ReadData extends ActionSupport {
	...
	private ArrayList<String> counteries ;

	public ArrayList<String> getCounteries() {
		return counteries;
	}

	public void setCounteries(ArrayList<String> counteries) {
	...
	public String dbStates() {
		//Do the database code or business logic here.
		counteries = new ArrayList<>();
		counteries.add("India");
		counteries.add("Pakistan");
		counteries.add("China");
		counteries.add("Nepal");
		counteries.add("Bhutan");
		states = new String[5];
		states[0] = "tamilnadu";
		states[1] = "kerala";
		states[2] = "karnataka";
